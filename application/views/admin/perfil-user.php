            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Correo</b> <a class="pull-right">1,322</a>
                </li>
                <li class="list-group-item">
                  <b>Telefono</b> <a class="pull-right">543</a>
                </li>
                <li class="list-group-item">
                  <b>Trillian</b> <a class="pull-right">13,287</a>
                </li>
              </ul>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#timeline" data-toggle="tab">Linea Tiempo</a></li>
              <li><a href="#settings" data-toggle="tab">Mis datos</a></li>
            </ul>
