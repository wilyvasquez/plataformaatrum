<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pagos <strong>Juan Cruz Perez</strong>
    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <dl class="dl-horizontal">
                <dt>NUMERO DE CONTRATO: </dt>
                <dd>000-000015</dd>
                <dt>TIPO DE CREDITO: </dt>
                <dd>SUZUCREDIT OAXACA.</dd>
                <dt>ESTATUS: </dt>
                <dd>
                ...
                <dd>(953) 114 3026.
                <dt>FECHA DE ALTA: </dt>
                <dd>25 de Enero de 2018, a la(s) 01:25:02 pm hrs.
                </dd>
              </dl>
            </div>
            <!-- /.box-body -->
        ...
        <div class="col-md-7">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Financiamiento</h3>
            ...
            <div class="box-body">
              <div class="col-lg-6 col-md-12 col-sm-6">
                <dl class="dl-horizontal">
                  <dt>BASE DEL CREDITO:</dt>
                  <dd>$25,490.00</dd>
                  <dt>IMPORTE CREDITO:</dt>
                  <dd>$30,490.00</dd>
                  <dt>ENGANCHE:</dt>
                  <dd>$10,000.00</dd>                 
                  <dt>COSTO APERTURA </dt>
                  <dd>$450.00</dd> 
              ...
              <div class="col-lg-6 col-md-12 col-sm-6">
                <dl class="dl-horizontal">
                  <dt>TOTAL PAGADO:</dt>
                  <dd>$10,587.00</dd>
                  <dt>CAPITAL PAGADO:</dt>
                  <dd>$25,487.00</dd>
                  <dt>DEUDA VENCIMIENTO:</dt>
                  <dd>$8,470.00</dd>
                  <dt>DEUDA CORRIENTE:</dt>
                  <dd>$5,879.00</dd>
                  <dt>MORAS:</dt>
                  <dd>$1,500.00</dd>
                </dl> 
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
              <table id="example2" class="table table-bordered table-striped" style="border-color: #D7D9DC">
                <thead>
                <tr>
                  <th>#</th>
                  <th>Costo</th>
